...
% * While this can't be directly inferred from the graphs, we know that braking 
...
%% 
% * Would like to add a third graph showing power consumption over a race but 
% would appreciate guidance about how to do this because I’m not sure if it’s 
% possible to record the current and voltage of the batteries over a race.
